namespace Gtk {
	...
	public enum NumberUpLayout {
		[Version (deprecated_since = "vala-0.34", replacement = "LRTB")]
		LEFT_TO_RIGHT_TOP_TO_BOTTOM,
		[Version (deprecated_since = "vala-0.34", replacement = "LRBT")]
		LEFT_TO_RIGHT_BOTTOM_TO_TOP,
		[Version (deprecated_since = "vala-0.34", replacement = "RLTB")]
		RIGHT_TO_LEFT_TOP_TO_BOTTOM,
		[Version (deprecated_since = "vala-0.34", replacement = "RLBT")]
		RIGHT_TO_LEFT_BOTTOM_TO_TOP,
		[Version (deprecated_since = "vala-0.34", replacement = "TBLR")]
		TOP_TO_BOTTOM_LEFT_TO_RIGHT,
		[Version (deprecated_since = "vala-0.34", replacement = "TBRL")]
		TOP_TO_BOTTOM_RIGHT_TO_LEFT,
		[Version (deprecated_since = "vala-0.34", replacement = "BTLR")]
		BOTTOM_TO_TOP_LEFT_TO_RIGHT,
		[Version (deprecated_since = "vala-0.34", replacement = "BTRL")]
